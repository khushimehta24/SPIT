  ...
  return (
    <>
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ my: 2 }}>
        ...
        <Link sx={{color: "#5DBAE8" }} variant="subtitle2" underline="hover">
          Forgot password?
        </Link>
      </Stack>

      {!load ? <LoadingButton sx={{ backgroundColor: "#5DBAE8" }} onClick={handleClick} fullWidth size="large" type="submit" variant="contained">
        Login
