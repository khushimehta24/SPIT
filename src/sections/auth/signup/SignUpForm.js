  ...
  return (
    <>
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ my: 2 }}>
        ...
        <Link variant="subtitle2" sx={{ color: "#5DBAE8" }} underline="hover">
          Keep me signed in
        </Link>
      </Stack>

      {!load ? <LoadingButton onClick={handleClick} sx={{ backgroundColor: "#5DBAE8" }} fullWidth size="large" type="submit" variant="contained">
        Sign Up
